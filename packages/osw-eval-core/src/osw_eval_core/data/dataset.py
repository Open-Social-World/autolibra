...
class MultiAgentDataset:
    ...
    def _init_metadata(self, name: str, description: str, version: str) -> DatasetMetadata:
        """Initialize or load dataset metadata"""
    ...
    def create_instance(
        ...
        self.metadata.agent_types = list(set(
    ...
    def get_instances_by_agent_type(self, agent_type: str) -> list[str]:
        ...
        for instance_id in self.list_instances():
            ...
            if any(agent.agent_type == agent_type for agent in instance.agents.values()):
