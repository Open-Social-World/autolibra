          ...
          <Card className="flex flex-col h-full">
            <CardHeader className="flex-shrink-0 border-b">
              {instanceDetails ? (
                <div>
                  <Header
                    title={instanceDetails.instance_data?.label || instanceDetails.instance_id}
                      ...
                      {instanceDetails.step_files.map(file => (
                        <div key={file.step_number} className="text-xs p-2 bg-muted rounded-md">
                          ...
                          <div className="mt-1 flex justify-end">
                            <a 
                              href={`http://localhost:8000/webvoyager/step_files/${instanceDetails.instance_id}/${file.step_number}`} 
                              target="_blank" 
